...
public class ClickGUI extends Screen {
   ...
   public void render(GuiGraphics g, int mouseX, int mouseY, float pPartialTick) {
      ...
      opensans.render(stack, "BlinkFix", (double)(windowX + 50.0F - opensans.getWidth("BlinkFix", 0.75) / 2.0F), (double)(windowY + 5.0F), Color.WHITE, true, 0.75);
      opensans.setAlpha(1.0F);
      if (this.selectedCategory != null) {
         this.titleAnimation.target = 255.0F;
         this.titleDisplayName = "< Back off "
